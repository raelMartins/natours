...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiZGV2cmFlbCIsImEiOiJja2k0NGc0bmswbWY5MnJzeWQ2ZHNieDVyIn0.fCGKeuyVf5O-QvIiyb0Egg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/devrael/cki45xtpt0jqu19qju8znxd2o',
    // scrollZoom: false
    // center: [-118.433748, 34.186182],
    // zoom: 8,
    interactive: false
  });
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: 'PATCH',
              url: "http://localhost:4000/api/v1/users/".concat(type === 'password' ? 'updateMyPassword' : 'updateMe'),
              data: data
            });
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Your account ".concat(type.toUpperCase(), " has been updated successfully"));
              console.log(res);
            }
...
if (userPasswordForm) userPasswordForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(e) {
    var prevPassword, newPassword, passwordConfirm;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            prevPassword = document.getElementById('password-current').value;
